...
LOG_DIR=/home/logs
	...
	echo "----------------------------------------" >> $LOG_DIR/terasortx2.log
	echo " " >> $LOG_DIR/terasortx2.log
	echo Start in `date +%H:%M:%S--%d/%m/%Y` >> $LOG_DIR/terasortx2.log
	
	$HADOOP_BIN $HADOOP_EXAMPLES terasort ./teragen-10GB ./terasort-10GB 2>&1>> $LOG_DIR/app_terasortx2.log
	./hdfs dfs -rm -r -f  terasort-10GB >> $LOG_DIR/app_terasortx2.log
